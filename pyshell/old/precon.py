...
from numpy import zeros, where, float64, dot, loadtxt, transpose, ones, average, maximum, ones_like, zeros_like, eye, meshgrid, arange, linalg, argsort, diag, sqrt, array, load, linspace, exp
