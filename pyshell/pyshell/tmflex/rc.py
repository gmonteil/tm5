...
HISTORY
    ...
    2014-06-20 Guillaume Monteil, IMAU
      split __init__ in __init__ and readfile
      one can now create an empty class, add keys to it, and then read the remaining keys from a file
      the idea is that the main keys can be set directly in python, and can be used to build the other keys. 
      It is fully backward compatible with the previous implementation.
"""
