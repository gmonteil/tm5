...
module chem_param
  ...
  ! species name
  !
  character*8, dimension(maxtrace) :: names = (/'CO2     '/)
  !
  ...
  real,dimension(maxtrace),parameter :: mixrat_unit = (/ 1.e6 /)
  character(len=3), dimension(maxtrace), parameter :: mixrat_unit_name = (/'ppm'/)
  ! some tracer emissions are best expressed in Tg/yr, some others in Kg/yr
  real,dimension(maxtrace),parameter :: emis_unit = (/ 1.0e-12 /)
  character(len=2), dimension(maxtrace), parameter :: emis_unit_name = (/ 'Pg' /)
