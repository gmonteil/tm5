...
module budget_global
  ...
  ! public routines
  public :: ini_zoneg, diagbudg, budget_transportg
...
!  integer,parameter     :: nbudg=7, nbud_vg=4
  ...
  real,dimension(nregions,ntracet)  :: init_mass = 0.0
  real,dimension(nregions,ntracet)  :: sum_deposition = 0.0
  real,dimension(nregions,ntracet)  :: sum_wet = 0.0
  real,dimension(nregions,ntracet)  :: sum_chemistry = 0.0
  real,dimension(nregions,ntracet)  :: sum_update = 0.0
  real,dimension(nregions,ntracet)  :: sum_advection = 0.0
  real,dimension(nregions,ntracet)  :: sum_stratosphere = 0.0
  real,dimension(nregions,ntracet)  :: sum_emission = 0.0
...
!  real, dimension(nbudg,nbud_vg,nreac)  :: budrrg
  ...
  real, dimension(nbudg,nbud_vg,njnum)  :: budrjg
  real, dimension(nbudg,nbud_vg,njnum)  :: budrjg_all
!  real, dimension(nbudg,nbud_vg,ntrace) :: buddryg
  real, dimension(nbudg,nbud_vg,ntrace) :: budwetg_lsp
  real, dimension(nbudg,nbud_vg,ntrace) :: budwetg_cp
!  real, dimension(nbudg,nbud_vg,ntrace) :: budwetg_nat
!  real, dimension(nbudg,nbud_vg,ntrace)  :: budemig
  real, dimension(:,:,:,:), allocatable  :: budemig

  real, dimension(nbudg,nbud_vg,ntrace) :: budstratg
  real, dimension(nbudg,nbud_vg,ntrace) :: budconcg
  real, dimension(nbudg,nbud_vg,ntrace) :: budinig
!  real, dimension(nbudg,nbud_vg,ntrace) :: buddryg_all
  real, dimension(nbudg,nbud_vg,ntrace) :: budwetg_lsp_all
  real, dimension(nbudg,nbud_vg,ntrace) :: budwetg_cp_all
!  real, dimension(nbudg,nbud_vg,ntrace) :: budwetg_nat_all
  real, dimension(nbudg,nbud_vg,ntrace) :: budemig_all
  real, dimension(nbudg,nbud_vg,ntrace) :: budstratg_all
  real, dimension(nbudg,nbud_vg,ntrace) :: budconcg_all
  real, dimension(nbudg,nbud_vg,ntrace) :: budinig_all
  real, dimension(nbudg,nbud_vg,ntrace) :: budchngg = 0.0
  real, dimension(nbudg,nbud_vg,ntrace) :: budchngg_all = 0.0
  real, dimension(nbudg,nbud_vg,nmark)  :: budmarkg
  real, dimension(nbudg,nbud_vg,nmark)  :: budmarkg_all
  real, dimension(nbudg,nbud_vg,nreacw) :: budrwg
  real, dimension(nbudg,nbud_vg,nreacw) :: budrwg_all
  real, dimension(nbudg,nbud_vg,ntracet):: budadvxg
  real, dimension(nbudg,nbud_vg,ntracet):: budadvyg
  real, dimension(nbudg,nbud_vg,ntracet):: budadvzg
  ...
  real, dimension(nbudg,nbud_vg,ntracet):: budconvg
  real, dimension(nbudg,nbud_vg,ntracet):: budconvg_all
  real, dimension(nbudg,nbud_vg,ntracet):: budvdifg
  real, dimension(nbudg,nbud_vg,ntracet):: budvdifg_all
...
!    use io_hdf,      only : DFACC_CREATE, DFNT_INT32, DFNT_INT64, DFNT_CHAR
    ...
    character(len=10), dimension(nproces), parameter :: proces_name=(/&
         ...
         'names     ','names     ','names     ','names     ','names     '/)
    integer,dimension(nproces),parameter :: proces_nr = (/ &
