...
module dims_grid
  ...
  integer, parameter  ::  xcyc    (nregions) = (/    1,   0 /)
  integer, parameter  ::  touch_np(nregions) = (/    1,   0 /)
  integer, parameter  ::  touch_sp(nregions) = (/    1,   0 /)
  integer, parameter  ::  xbeg    (nregions) = (/ -180, -36 /)
  integer, parameter  ::  xend    (nregions) = (/  180,  54 /)
  integer, parameter  ::  ybeg    (nregions) = (/  -90,  22 /)
  integer, parameter  ::  yend    (nregions) = (/   90,  74 /)
  integer, parameter  ::  im      (nregions) = (/   60,  30 /)
  integer, parameter  ::  jm      (nregions) = (/   45,  26 /)
  ...
  integer, parameter  :: xref(0:nregions) = (/ 1, 1, 2/)
  integer, parameter  :: yref(0:nregions) = (/ 1, 1, 2/)
  integer, parameter  :: zref(0:nregions) = (/ 1, 1, 1/)
  integer, parameter  :: tref(0:nregions) = (/ 1, 1, 2/)
  ...
  integer, parameter  ::  parent(nregions) = (/ 0, 1/)
